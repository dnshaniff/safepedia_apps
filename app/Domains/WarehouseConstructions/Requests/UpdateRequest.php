...
class UpdateRequest extends FormRequest
{
  ...
  {
    return [
      'warehouse_name' => 'required|string|min:4|max:255',
      'latitude' => 'required|numeric',
      'longitude' => 'required|numeric',

      'item-budget' => 'required|array|min:1',
      'item-budget.*.item_name' => 'required|string|max:255',
      'item-budget.*.quantity' => 'required|numeric|min:1',
      'item-budget.*.unit_price' => 'required|numeric|min:0',

      'documents' => 'nullable|array|max:5',
      'documents.*' => 'nullable|file|mimes:pdf|max:2048',

      'removed_documents' => 'nullable|array',
      'removed_documents.*' => 'integer|exists:warehouse_construction_documents,id',
    ];
  }
