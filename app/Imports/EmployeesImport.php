...
class EmployeesImport implements ToModel, WithHeadingRow, SkipsEmptyRows, WithChunkReading, WithBatchInserts, WithValidation
{
  ...
  public function rules(): array
  {
    return [
      ...
      '*.office_email' => ['nullable', 'email', 'distinct', 'unique:employees,office_email'],
      '*.personal_email' => ['nullable', 'email', 'distinct', 'unique:employees,personal_email'],
      '*.phone_number' => ['nullable', 'distinct', 'unique:employees,phone_number'],
