...
namespace App\Domains\Articles\Queries;
...
class IndexService
{
  public function execute(array $params): array
  {
    ...
    $baseQuery = Article::query()->with(['thumbnail:id,article_id,file_path', 'creator', 'editor', 'deleter']);
    ...
    foreach ($rows as $row) {
      $data[] = [
        ...
        'title' => $row->title,
        'content' => $row->content,
        'project_at' => Carbon::parse($row->project_at)->format('d F Y'),
