...
@section('page-script')
    @vite(['resources/assets/js/app/select2-utils.js', 'resources/assets/js/ga/asset_locations.js'])
@endsection

@section('content')
    <h4 class="pt-3">Asset Location List</h4>
    <div class="row g-4 mb-3">
        <div class="col-12">
            <div class="card">
                <div class="card-datatable table-responsive text-nowrap">
                    <table class="datatables-asset_locations table table-hover border-top">
                        <thead>
                            <tr>
                                <th width="1px">#</th>
    ...
    <div class="modal fade" id="modalAssetLocation" tabindex="-1" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <form id="formAssetLocation" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="backDropModalTitle">Asset Location</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body row">
                    <div class="col-12 mb-3">
                        <label class="form-label" for="location_name">Location Name <strong
                                class="text-danger">**</strong></label>
                        <input type="text" id="location_name" name="location_name" class="form-control"
                            placeholder="Lt. 5 Ruang Server" autofocus />
                    </div>
                </div>
